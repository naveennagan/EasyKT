...
export const Trigger = () => {
  const {
    appState: { triggersData: triggersListData },
    setAppState,
  ...
  const triggerItemView = (index, trigger) => {
    return (
      <div className="trigger-row">
        ...
        <p className="trigger-row-title">
          {" "}
          {`Step ${trigger.currentStep} of ${trigger.totalSteps} completed.`}{" "}
        </p>
        <p className="trigger-row-title"> {trigger.assignedTo} </p>
        <p
          className={`trigger-row-title ${
            trigger.status === "Done" ? "trigger-completed" : "trigger-progress"
          }`}
        >
          {" "}
          {trigger.status}{" "}
        </p>
        <p className="trigger-row-title trigger-row-action">
          {" "}
