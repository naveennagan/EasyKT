...
export const tasksData = [
    {
        ...
        triggeredBy: "Steve",
        steps: [
            {title: 'Step 1', description: {type: Type.Text, data: {text: JioText1}}, completedBy: ['Naveen', 'Abhishek', 'Nandita']},
            {title: 'Step 2', description: {type: Type.Image, data: {text: JioText2}}, completedBy: ['Naveen', 'Nandita']},
            {title: 'Step 3', description: {type: Type.Image, data: JioImageData},completedBy: ['Naveen', 'Abhishek', 'Vedika']},
            {title: 'Step 4', description: {type: Type.Video, data: JioVideoData}, completedBy: ['Naveen']},
            {title: 'Step 5', description:{type: Type.Text, data: {text: JioText3}}, completedBy: ['Naveen']},
            {title: 'Final Step 6', description: {type: Type.Quiz, data: JioQuizData}, completedBy: ['Naveen']}
        ]
    },
    {
        id: "2",
        ...
        triggeredBy: "John",
        steps: [
            {title: 'Step 1', description: {type: Type.Image, data: ImageData},completedBy: ['Naveen', 'Abhishek', 'Vedika']},
            {title: 'Step 2', description: {type: Type.Text, data: TextData},completedBy: ['Naveen', 'Abhishek', 'Vedika']},
            {title: 'Step 3', description: {type: Type.Text, data: TextData},completedBy: ['Abhishek', 'Vedika']},
            {title: 'Step 4', description: {type: Type.Image, data: ImageData},completedBy: ['Abhishek', 'Vedika']},
            {title: 'Final step 5',description: {type: Type.Quiz, data: QuizData},completedBy: ['Abhishek']},
        ]
    },
    {
        id: "3",
        ...
        triggeredBy: "John",
        steps: [
            {title: 'Step 1', description: {type: Type.Image, data: ImageData},completedBy: ['Vedika', 'Nandita']},
            {title: 'Step 2', description: {type: Type.Text, data: TextData},completedBy: ['Vedika', 'Nandita']},
            {title: 'Final step 3', description: {type: Type.Quiz, data: QuizData},completedBy: ['Vedika']}
        ]
    },
    {
        id: "4",
        ...
        triggeredBy: "Steve",
        steps: [
            {title: 'Step 1', description: {type: Type.Text, data: TextData},completedBy: ['Naveen', 'Abhishek', 'Vedika']},
            {title: 'Step 2', description: {type: Type.Image, data: ImageData},completedBy: ['Naveen', 'Abhishek', 'Vedika']},
            {title: 'Step 3', description: {type: Type.Text, data: TextData},completedBy: ['Naveen', 'Abhishek']},
            {title: 'Step 4', description: {type: Type.Video, data: VideoData},completedBy: ['Naveen', 'Abhishek']},
            {title: 'Final step 5', description: {type: Type.Quiz, data: QuizData},completedBy: ['Abhishek']},
        ]
    },
    {
        ...
        triggeredBy: "John",
        steps: [
            {title: 'Step 1',description: {type: Type.Video, data: VideoData},completedBy: ['Vedika', 'Nandita']},
            {title: 'Step 2', description: {type: Type.Text, data: TextData},completedBy: ['Vedika', 'Nandita']},
            {title: 'Step 3', description: {type: Type.Image, data: ImageData},completedBy: ['Vedika', 'Nandita']},
            {title: 'Final step 4',description: {type: Type.Quiz, data: QuizData},completedBy: ['Nandita']}
        ]
    }
