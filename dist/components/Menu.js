...
var Menu = function Menu() {
  var _useContext = (0, _react.useContext)(_AppContext.AppContext),
      ...
      resetData = _useContext.resetData;
  ...
  var updateWorkflow = function updateWorkflow() {
    var results = appState.workflowData.reduce(function (acc, workflow) {
  ...
  var updateTasks = function updateTasks() {
    var results = appState.tasksData.reduce(function (acc, task) {
  ...
  var updateTrigger = function updateTrigger() {
    var results = appState.triggersData.reduce(function (acc, trigger) {
